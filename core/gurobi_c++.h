...
enum GRB_IntParam {
  ...
  GRB_IntParam_BarIterationLimit,
...
GRBTempConstr operator<=(GRBLinExpr x, GRBLinExpr y);
GRBTempConstr operator>=(GRBLinExpr x, GRBLinExpr y);
GRBTempConstr operator==(GRBLinExpr x, GRBLinExpr y);
...
class GRBModel
{
  ...
  public:
    ...
    void    setObjective(GRBLinExpr obje);
    void    setObjective(GRBQuadExpr obje);
...
class GRBTempConstr
{
  ...
  public:
    ...
    friend class GRBModel;
    friend GRBTempConstr operator<=(GRBLinExpr x, GRBLinExpr y);
    friend GRBTempConstr operator>=(GRBLinExpr x, GRBLinExpr y);
    friend GRBTempConstr operator==(GRBLinExpr x, GRBLinExpr y);
};
#endif
